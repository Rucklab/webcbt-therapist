...
Is there a need for the OCD-NET to provide support in analysing the data, or can this be handled by the collaborator? This is important to consider already when planning the project as it affects the types of agreements needed.
