...
You have done a thourough job on 

Stort tack för dina hemuppgifter till modul 3. Du har gjort ett väldigt gediget arbete med denna modul som handlar om tolkningar. Som framgår av det du skriver har du tagit till dig KBT-perspektivet att det egentligen inte är tankarna det är fel på vid tvångssyndrom (det är väldigt många som har dem) utan att man så att säga "köper" tankarna och agerar på dem i form av ritualer och andra beteenden. Det problematiska med detta är att ritualerna bekräftar "riktigheten" i tvångstankarna.

Något som är väldigt viktigt när det gäller tolkningar är också detta att vi i denna behandling inte kommer att gå in för att ändra på tankarna direkt, genom att tex. försöka motbevisa dem. Detta är därför att tvångstankar inte svarar på logik - de kräver att man får nya erfarenheter för att de ska ge med sig.

Sammanfattningsvis har du återigen gjort en väldigt bra modul och du har nu tillgång till modul 4. Lycka till!
...
Ang. din molande tankar så är mitt förslag att du jobbar med fullständig acceptans av dessa. D.v.s. när du får en tanke "tänk om jag varit flörtig" så låt den tanken finnas där, acceptera möjligheten att du kanske har varit flörtig, du får ta den chansen. Gör ingenting med tanken mer än så, försök inte debattera med den eller diskutera. Förhåll dig istället gentemot tanken att "Ja, jag var nog flörtig mot alla dessa människor, det får vara så, jag får ta den risken". Obs att detta är inte lätt, vi människor hamnar lätt i diskussion med våra tankar. Men jag tycker du ska börja träna dig i nu att acceptera dessa tankar. De får vara där lika mycket som andra tankar. Alla tankar är välkomna. Varför är alla tankar välkomna? Jo därför att så fort vi försöker stänga ute några tankar så bryter de sig in förr eller senare. Vad tycker du? 

Hej X! Du kan inte inte tänka tankar. Du kommer alltid ha sexuella tankar om alla i din närhet. Jag har det. Vi människor har sådana tankar. Jag vill påminna dig om att istället välkomna dessa tankar, låt dem få finnas där. Så länge du börjar argumentera och analysera dem kommer du vara fånge i dem och betrakta dem som jobbiga. Jag får varje morgon tankar om att jag ska våldta min dotter när jag byter blöja på henne. Jag kan inte inte få dessa tankar. Jag vet att om jag börjar argumentera med dem och försöka få bort dem så kommer de tillbaka och blir jobbigare. Så istället accepterar jag dem och låter dem få finnas där. Du måste nu acceptera dessa tankar X, inga usch nu. Bara Välkommen kära tankar! 

Bra jobbat med exponeringarna! Jag vill att du läser igenom modul 9 nu som kan passa dig bra. 
...
Patients who express ongoing suicidal thoughts or have ongoing self-harm behaviour should be referred to treatments with more intensive monitoring and are generally not recommended to start ICBT. However, some patients who undergo CBT for OCD and BDD express a short-term increase in suicidal ideation or self-harm behaviour while in treatment. If this is detected either through patient-therapist messages or in weekly measurements, we recommend that therapists follow local guidelines or use the following outline as a guide:

1. Call the patient immediately
2. Explain that it is standard procedure to call when a patient indicates heightened suicidal ideation or increased risk of self-harm
3. Follow a hierarchy of questions, such as those in the M.I.N.I. interview [@sheehan1998]
...
5. If the immediate risk is high (i.e. PHQ-9 score of 3), advise the patient to seek help at your centre or at a 24-hour psychiatric care unit.
