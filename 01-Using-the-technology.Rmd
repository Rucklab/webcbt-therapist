...
**Therapists access the platform via this URL: [webcbt.tst.ki.se/t1](webcbt.tst.ki.se/t1)**
...
A new message from a patient will be indicated by this icon turning red ![](images/message-icon.png). Navigate to *Treatments -> participant messages* to view the message and write a response. See the chapter [Being an effective ICBT therapist][Being an effective ICBT therapist] for guidelines on how to write messages.
